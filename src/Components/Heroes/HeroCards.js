...
const HeroCards = ({hero}) => {
  ...
  return (
    <a href={`https://www.dota2.com/hero/${hero.localized_name.toLowerCase().replaceAll(" ","")}`} className=" w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-1.5 h-full" target="_blank" rel="noreferrer" >
